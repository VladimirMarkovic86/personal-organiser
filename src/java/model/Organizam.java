...
public class Organizam implements Serializable {
	...
	public void setTreningObrok(int treningObrok) {
		switch(treningObrok){
			case 1: this.treningObrok = VrstaObroka.DORUCAK;
				break;
			case 2: this.treningObrok = VrstaObroka.RUCAK;
				break;
			case 3:	this.treningObrok = VrstaObroka.VECERA;
				break;
			case 0:	this.treningObrok = VrstaObroka.BEZ_OBROKA;
				break;
			default: this.treningObrok = VrstaObroka.BEZ_OBROKA;
				break;
		}
	}
	...
	public NacinIshrane getNacinIshraneEnum(){
		switch (nacinIshrane) {
			case 0: return NacinIshrane.VEGETARIJANSKI;
			case 1: return NacinIshrane.SVE;
			default:return NacinIshrane.SVE;
		}
	}
